...
mat, surf, curfield, del, E, quf, qu,thick_orig, thick_orig_slope = IBLThickCoupled(surfvis, curfieldvis, 200, true, 750, dtstar, startflag, writeflag, writeInterval, delvort)

#@run IBLThickCoupled(surfvis, curfieldvis, 200, 1000, dtstar, startflag, writeflag, writeInterval, delvort)
